...
from fabulexa_export.corrupters.state import CorruptReport, CorruptState, WorkingTable
...
from fabulexa_export.reader.conformance import validate as run_conformance

if TYPE_CHECKING:
    from pathlib import Path

    from fabulexa_export.config.models import CorruptConfig, CorruptOperation
...
def corrupt_emit(
    ...
    `fabexport corrupt <emit_dir> --config <corrupt.yaml> --out <out_dir>` wraps
