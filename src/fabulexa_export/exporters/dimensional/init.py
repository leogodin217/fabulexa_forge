"""Sidecar-driven candidate config generator for `fabexport init`.
...
from fabulexa_export.errors import InitRequiresRecordRoles
from fabulexa_export.reader.relations import distinct_prop_values
...
def _build_candidate_yaml(emit: "Emit") -> str:
    ...
    w("# Candidate dimensional export config — generated by `fabexport init`")
