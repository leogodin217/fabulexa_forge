...
derivation's column order / property-partition helpers), fabulexa_export.errors,
...
if TYPE_CHECKING:
    ...
    from fabulexa_export.reader.sidecar import RecordRoles, Sidecar

from fabulexa_export.derivations.properties import has_presentation_id
from fabulexa_export.derivations.row_state_events import resolve_stream_columns
from fabulexa_export.derivations.state_at import STATE_AT_COLUMNS
...
from fabulexa_export.exporters.reserved_names import (
