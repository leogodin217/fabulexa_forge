...
row-state-events fold and the state-at derivation), fabulexa_export.anchor,
fabulexa_export.errors, the sibling source.columns module, config.models / the
...
if TYPE_CHECKING:
    ...
    from fabulexa_export.exporters.source.plan import SourceTableSpec
    from fabulexa_export.incremental.windows import Window
    from fabulexa_export.reader.sidecar import Sidecar

from fabulexa_export.anchor import render_anchor_timestamp_expr
from fabulexa_export.derivations.row_state_events import build_row_state_events_sql
from fabulexa_export.derivations.state_at import build_state_at_sql
from fabulexa_export.exporters.source.columns import _PROP_PREFIX, _scalar_properties
