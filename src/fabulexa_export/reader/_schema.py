...
def _read_schema_text() -> str:
    ...
    1. importlib.resources — correct for a wheel / non-editable install where
       force-include places the file inside the fabulexa_export package.
    2. __file__-relative path — correct for an editable (in-tree) install
       where importlib.resources resolves to src/fabulexa_export/ and there
    ...
    pkg_ref = importlib.resources.files("fabulexa_export")
    ...
    # _schema.py lives at src/fabulexa_export/reader/_schema.py
