...
from fabulexa_forge.corrupters.validate import mutation_eligible_columns
...
if TYPE_CHECKING:
    ...
    from fabulexa_forge.config.models import CorruptOperation, MutationSpec
    from fabulexa_forge.corrupters.manifest import ImpactCode
    from fabulexa_forge.corrupters.operations._impact import TablePopulation
