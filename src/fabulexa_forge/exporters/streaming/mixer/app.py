...
if TYPE_CHECKING:
    ...
    from fabulexa_forge.exporters.streaming.mixer.consumer import ConsumerRunState
...
def derive_meters(state: "MixerRunState") -> "MetersOut":
    ...
    """
    from fabulexa_forge.exporters.streaming.mixer.wire import MetersOut, TopicMeterOut
