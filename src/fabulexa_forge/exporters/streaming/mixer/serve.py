...
async def serve_mixer(
    ...
    from fabulexa_forge.exporters.streaming.mixer.scheduler import schedule_releases
    ...
    from fabulexa_forge.exporters.streaming.mixer.app import build_app
    ...
    async def _lifespan(app_: object) -> AsyncIterator[None]:
        ...
        if source is not None and state.consumer is not None:
            from fabulexa_forge.exporters.streaming.mixer.consumer import run_consumer
